 ...
 * 0.10 (May 13 2018) adds default 'corpusClick' function
 * 
 * @copyright
...
var ClsDocuskyManageDbListSimpleUI = function(param) {       // constructor
   ...
   me.widgetEvents = { dbClick: null,     // 2017-12-28: a callback function
                       corpusAttCntClick: null,                // 2018-01-08: 若 enable 此項，則 corpusClick/attCntClick 將失效
                       corpusClick:                            
                          function(db, corpus) {               // 2018-05-13: default function ==> open a new window to display db+corpus content
   ...
   var init = function() {
      ...
      $("#" + loginSubmitId).click(function(e) {
         me.login($("#" + dsUsernameId).val(), $("#" + dsPasswordId).val());    // 2018-01-30
      });
   ...
   var displayDbList = function(evt, successFunc) {
      ...
      $("span.dsw-dbClick").on("click", function() {
         me.hideWidget();
         if (typeof me.widgetEvents.dbClick === 'function') me.widgetEvents.dbClick($(this).attr("x-db"));
      });
      $("span.dsw-corpusAttCntClick").on("click", function() {
         me.hideWidget();
         if (typeof me.widgetEvents.corpusAttCntClick === 'function') me.widgetEvents.corpusAttCntClick($(this).attr("x-db"), $(this).attr("x-corpus"));
      });
      $("span.dsw-corpusClick").on("click", function() {
         me.hideWidget();
         if (typeof me.widgetEvents.corpusClick === 'function') me.widgetEvents.corpusClick($(this).attr("x-db"), $(this).attr("x-corpus"));
      });
      $("span.dsw-attCntClick").on("click", function() {
         me.hideWidget();
         if (typeof me.widgetEvents.attCntClick === 'function') me.widgetEvents.attCntClick($(this).attr("x-db"), $(this).attr("x-corpus"));
      });
   ...
   me.manageDbList = function(evt, successFunc) {
      //if (!me) { var me = this; }
